...
class BukuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('petugas.buku.index', compact('kategori', 'penerbit', 'penulis','buku'));
    }
    ...
    public function create()
    {
        ...
        $penerbit = penerbit::all();
        $penulis = penulis::all();
        return view('petugas.buku.create', compact('kategori','penerbit','penulis'));
    }
    ...
    public function edit($id)
    {
        ...
        $penerbit = penerbit::all();
        $penulis = penulis::all();
        return view('petugas.buku.edit', compact('kategori','penerbit','penulis','buku'));
    }
