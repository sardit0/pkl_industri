            ...
            <form class="row g-3" enctype="multipart/form-data">
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input class="form-control mb-3" type="text" name="nama" placeholder="Name" value="{{ Auth::user()->name }}" disabled>
                ...
                <div class="col-md-6">
                    <label for="input13" class="form-label">Loan date</label>
                    <input class="form-control mb-3" type="date" name="tanggal_minjem" value="{{ $minjem->tanggal_minjem }}" disabled>
                </div>

                <div class="col-md-6">
                    <label for="input13" class="form-label">Loan deadline</label>
                    <input class="form-control mb-3" type="date" name="batas_tanggal" value="{{ $minjem->batas_tanggal }}" disabled>
                </div>

                <div class="col-md-6">
                    <label for="input13" class="form-label">Return date</label>
                    <input class="form-control mb-3" type="date" name="tanggal_kembali" value="{{ $minjem->tanggal_kembali }}" disabled>
                </div>

                <div class="col-md-6">
                    <label for="input13" class="form-label">Amount</label>
                    <div class="position-relative">
                        <input class="form-control mb-3" type="number" name="jumlah" placeholder="Jumlah" value="{{$minjem->jumlah}}" disabled>
                    </div>
                </div>
