...
class MinjemController extends Controller
{
    ...
    public function history()
    {
        ...
        return view('petugas.peminjaman.history', compact('minjem'));
    }
    ...
    public function index(Request $request)
    {
       ...
       if ($request->filled('status')) {
        ...
        return view('petugas.peminjaman.index', compact('buku', 'kategori', 'penulis', 'penerbit', 'minjem', 'user'));
    }
    public function indexAdmin()
    {
        ...
        return view('petugas.peminjamanadmin.index', compact('buku', 'kategori', 'penulis', 'penerbit', 'minjem', 'user'));
    }
    ...
    public function create()
    {
        ...
        return view('petugas.peminjaman.create', compact('minjem', 'buku', 'sekarang', 'batastanggal'));
    }
    ...
    public function showpengajuanuser($id)
    {
        ...
        $buku = Buku::all();
        $user = Auth::user();
        return view('petugas.peminjaman.showpengajuan', compact('user', 'buku', 'minjem'));
    }
    public function show($id)
    {
        $minjem = Minjem::with('buku')->findOrFail($id);
        return view('petugas.peminjamanadmin.detail', compact('minjem'));
    }
    ...
    public function edit($id)
    {
        ...
        $penerbit = Penerbit::all();
        $minjem = Minjem::findOrFail($id);
        return view('petugas.peminjaman.edit', compact('minjem', 'buku', 'kategori', 'penulis', 'penerbit', 'user'));
    }
