      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('petugasdashboard') }}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('petugas.kategori.index') }}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('petugas.penulis.index') }}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('petugas.penerbit.index') }}" aria-expanded="false">
              <span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{ route('petugas.buku.index') }}" aria-expanded="false">
              <span>
