                ...
                {{-- <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                    <li class="nav-item dropdown">
                        <a href="javascrpt:;" data-bs-toggle="dropdown">
                            <img src="{{ asset('User/assets/images/person-1.png') }}" class="rounded-circle p-1 border"
                                width="45" height="45" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                            <a class="dropdown-item  gap-2 py-2" href="{{ route('profile') }}">
                                <div class="text-center">
                                    <img src="{{ asset('User/assets/images/person-1.png') }}"
                            ...
                            <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('login') }}"
                                ...
                                <i class="mdi mdi-power"></i>Logout</span></a>
