...
<div class="col-12 col-xl-12">
    <div class="card m-3">
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('petugas.kategori.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-12 mt-3">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <a type="submit" href="{{route('petugas.kategori.index')}}" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
